                    ...
                    user?.role === 'admin' || user?.role === 'organizer'
                        ...
                        <div className="p-10 bg-white rounded-md">
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                                <div>
                                    <label className="block text-secondary font-semibold mb-1">Your Name</label>
                                    <input
                                        type="text"
                                ...
                                <div>
                                    <label className="block text-secondary font-semibold mb-1">Company Name</label>
                                    <input
                                        type="text"
                                ...
                                <div>
                                    <label htmlFor="experience" className="block text-secondary font-semibold mb-1">Event Organization Experience</label>
                                    <textarea
                                ...
                                <div>
                                    <label className="block text-secondary font-semibold mb-1">Event Organization Skills</label>
                                    <textarea
