  ...
  const fetchProducts = async () => {
    try {
      const response = await fetch(
        "http://events.konza.go.ke:8080/products"
          ...
          <div>
            <div className=" mx-5 my-4 flex justify-center">
              ...
              <Link to="/my-cart">
                <button
                  type="button"
                  className="relative text-secondary bg-primary focus:ring-4 focus:outline-none focus:ring-lime-300 dark:focus:ring-lime-800 shadow-lg shadow-lime-500/50 dark:shadow-lg dark:shadow-lime-800/80 rounded-lg text-xl font-bold px-5 py-4 text-center inline-flex items-center me-2"
                >
                  ...
                  <span className="absolute -top-1 -right-1 bg-dark_01 text-white rounded-full px-2 py-1 text-xs">
                    {cartItemCount}
