...
import logo from "../../assets/logo/konzalogo.png";
...
const Contact = () => {
  ...
  return (
    <div>
      <h2 className="text-4xl text-center font-semibold mt-5 uppercase">
        Contact Us
      </h2>
      <div className="mt-10 p-5 flex flex-col md:flex-row max-w-5xl mx-auto text-black ">
        <div className=" md:w-1/2">
          ...
          <hr className="w-32 " />
          <h2 className="text-2xl font-semibold">Located along Mombasa Rd</h2>
          <p className="text-base mb-3">Book online or call</p>
          <h2 className="text-2xl font-semibold">info@events.konza.go.ke</h2>
        ...
        <div className="md:w-1/2 mt-10 md:mt-0 md:ml-20">
          ...
          <form onSubmit={handleSubmit} className="">
            ...
            <button
              type="submit"
              className="flex justify-center items-center  text-white w-auto mx-auto mt-2 p-2 bg-dark_01 hover:bg-primary focus:outline-none dark:focus:ring-pink-800 shadow-lg  dark:shadow-lg lg:w-auto focus:ring-4 focus:ring-opacity-50 rounded-lg px-5"
            >
              Send Message
            </button>
          </form>
