        ...
        <div className="flex w-full items-center justify-between md:max-w-7xl md:px-12 mx-auto">
          ...
          <div className="flex justify-center items-center">
            <Link
              ...
              to="/"
            >
              <img src={logo} className="w-24 md:w-36" alt="Konza Technopolis Logo" />
            </Link>
          </div>
          <div
          ...
          {user ? (
            ...
            <div className="flex items-center gap-2">
              <Link
                to="/login"
                type="button"
                className="inline-block rounded bg-dark_01 px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white transition duration-150 ease-in-out hover:bg-dark_01 focus:bg-dark_01 focus:outline-none focus:ring-0 active:bg-dark_01"
              >
                Login
              </Link>
              <Link
