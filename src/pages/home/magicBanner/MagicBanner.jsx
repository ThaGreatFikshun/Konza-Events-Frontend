...
import img1 from "./image/slider4.png";
import img2 from "./image/slider6.jpeg";
import img3 from "./image/slider2.jpeg";
import img4 from "./image/slider3.jpeg";
            ...
            >
              ...
              <div className="content">
                ...
                <div className="author backdrop-brightness-50 w-[38%]">
                  <p className="pl-4">Konza Events</p>
                </div>
                ...
                */}
                ...
                <div>
                  <div>
                    <p className="text-xl ml-1 font-semibold tracking-wider text-slate-300">Konza Events</p>
                  </div>
                  <div className="my-5"><h1 className="text-3xl lg:text-6xl font-bold text-slate-200">Our Events</h1></div>
                  <div className="my-5"><h1 className="drop-shadow-2xl text-dark_01 text-5xl lg:text-7xl font-bold">Book Now!</h1></div>
                ...
                <Link to="/events">
                  <button
                    type="button"
                    className="mt-14 text-white bg-dark_01 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-pink-300 dark:focus:ring-pink-800 font-medium rounded-lg text-lg px-7 py-2 text-center  mb-2"
                  >
                    See More
                  </button>
                </Link>
