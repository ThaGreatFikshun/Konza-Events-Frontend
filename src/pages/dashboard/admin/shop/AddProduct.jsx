  ...
  return (
    <div className="">
      <div className="flex justify-center items-center">
        <h3 className="text-dark_01 text-4xl font-bold py-5">Add Product</h3>
      </div>
      <div className="bg-white dark:bg-[#0c1427] border dark:border-gray-800  rounded py-2 px-3 md:w-3/4 mx-auto">
        <form
          className="w-full  space-y-2 p-3 md:p-5  rounded-md"
          onSubmit={handleSubmit(onSubmit)}
        >
          {/* <div className=" ">
            <label className="block text-sm font-medium text-secondary py-1.5">
          ...
          <div className="md:flex gap-3 ">
            <div className="md:w-1/2">
              <label className="">
                <span className="block text-sm font-medium text-secondary py-1.5">
                  Product name
                </span>
              </label>
              <input
