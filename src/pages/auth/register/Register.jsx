                    ...
                    <div className="bg-white dark:bg-gray-900 px-10 py-5 rounded-xl w-screen shadow-md max-w-sm">
                        <div className="space-y-4">
                            <div className="text-center space-y-2">
                                ...
                                <small className="text-gray-400 dark:text-gray-200">
                                    Create an account to start using Konza Events
                                </small>
                            </div>
                            ...
                            <div className="relative">
                                ...
                                <span
                                    ...
                                    className="absolute top-[38px] text-secondary right-3 cursor-pointer select-none"
                                >
                                    {passwordShow ? (
                                        <svg
                        ...
                        <div>
                            <div className="flex items-center my-3">
                                <span
                                    aria-hidden="true"
                                    className="grow bg-gray-100 rounded h-0.5 dark:bg-secondary/75"
                                />
                                <span className="text-xs font-medium text-gray-800 bg-gray-100 rounded-full px-3 py-1 dark:bg-secondary dark:text-gray-200">
                                    or sign up with
                                </span>
                                <span
                                    aria-hidden="true"
                            ...
                            <div className="p-5 text-sm text-center">
                                ...
                                <Link
                                    to="/login"
                                    className="font-medium text-primary hover:text-dark_01 dark:text-dark_01 dark:hover:text-blue-300"
                                >
