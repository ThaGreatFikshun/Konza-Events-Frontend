...
const PaymentHistory = () => {
  ...
  const fetchPaymentHistory = async () => {
    const response = await axios.get(
      `http://events.konza.go.ke:8080/order/${user?.email}`
    );
  ...
  return (
    <div>
      <h2 className="text-center text-dark_01 text-2xl font-semibold mb-4">
        Payment History
      </h2>

      <div className="overflow-x-auto">
        <table className="table-auto w-full">
          <thead className="text-sm border-b text-primary uppercase bg-white font-semibold">
            <tr>
