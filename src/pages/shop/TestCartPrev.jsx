...
const MyCart = () => {
  ...
  return (
    <div>
      <section className="flex items-center bg-gray-50 xl:h-screen font-poppins dark:bg-secondary ">
        <div className="justify-center flex-1 px-1 py-6 mx-auto max-w-7xl lg:py-4 md:px-6">
          ...
          <div className="flex flex-wrap">
            <div className="w-full lg:w-8/12">
              <div className="px-10">
                {/* card 1 start  */}
                <div className="relative flex flex-wrap items-center pb-8 mb-8 -mx-4 border-b border-gray-200 dark:border-secondary xl:justify-between border-opacity-40">
                  ...
                  <div className="w-full px-4 mt-6 mb-6 xl:w-auto xl:mb-0 xl:mt-0">
                    <div className="flex items-center">
                      ...
                      <div className="inline-flex items-center px-4 font-semibold text-secondary border border-gray-300 rounded-md dark:bg-gray-800 dark:border-secondary ">
                        <button className="py-2 pr-2 border-r border-gray-300 dark:border-gray-600 dark:text-gray-400 hover:text-secondary">
                          <svg
                        ...
                        <input
                          ...
                          placeholder="1"
                        />
                        <button className="py-2 pl-2 border-l border-gray-300 dark:border-gray-600 hover:text-secondary dark:text-gray-400">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
                            height="16"
            ...
            <div className="w-full lg:w-4/12">
              <div className="px-6 mb-14">
                <div className="mb-10">
                  <span className="mb-6 text-3xl font-bold text-secondary dark:text-gray-400">
                    Apply Coupon
                  </span>
                  <input
                    type="text"
                    className="flex-1 w-full px-8 py-4 mt-4 font-normal placeholder-gray-400 border dark:bg-gray-800 rounded-xl dark:border-secondary dark:placeholder-secondary md:flex-none md:mr-6 dark:text-gray-400"
                    placeholder="x304k45"
                    required=""
                  />
                  <a
