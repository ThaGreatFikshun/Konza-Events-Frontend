                ...
                <div className="grid grid-cols-1 md:grid-cols-3 my-10 md:my-20 gap-6">
                    <div className="md:col-span-1">
                        ...
                        <div className="bg-gray-50 shadow-md rounded-md mt-8">
                            ...
                            <div className="mt-3">
                                <button
                                    className="block w-full text-left p-5 hover:bg-dark_01 hover:text-white text-xl border-b"
                                ...
                                >Business</button>
                                <button
                                    className="block w-full text-left p-5 hover:bg-dark_01 hover:text-white text-xl"
