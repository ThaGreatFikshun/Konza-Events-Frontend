...
import customimg from "../../home/magicBanner/image/slider6.jpeg";
import hostimg from "../../home/magicBanner/image/slider5.jpeg";
import shopimg from "../../home/magicBanner/image/slider4.png";
      ...
      <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-8 lg:gap-24 m-3 lg:m-12">
        ...
        <div className="rounded-md shadow-lg transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105 hover:shadow-lg bg-white hover:bg-gray-100">
          <div className="rounded-t-md shadow-lg h-60 relative overflow-hidden ">
            ...
            />
            <div className="absolute bg-dark_01 hover:bg-primary bottom-0 left-0 px-6 py-3 text-white font-semibold rounded-tr-md flex items-center gap-3">
              {" "}
          ...
          <div className="px-4 py-6">
            ...
            Tailor Your Events to Your Preference
            </h2>

            <p className="my-3 text-center text-sm text-secondary font-medium gap-2">
              Unforgettable Experiences Through Custom-Designed Events
            ...
            <div className="flex justify-center">
              <Link to="/create-your-event">
                <button
                  type="button"
                  className=" text-white bg-primary hover:bg-dark_01 focus:ring-4 focus:outline-none shadow-lg dark:shadow-lg font-medium rounded-lg lg:text-lg px-5 py-2.5 text-center me-2 mb-2"
                >
                  Request Now
                </button>
              </Link>
          ...
          <div className="px-4 py-6">
            ...
            <div className="flex justify-center">
              <Link to="/events">
                <button
                  type="button"
                  className=" text-white bg-primary hover:bg-dark_01 focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg lg:text-lg px-5 py-2.5 text-center me-2 mb-2"
                >
                  Book Your Ticket
                </button>
              </Link>
          ...
          <div className="px-4 py-6">
            ...
            <div className="flex justify-center">
              <Link to="/request-organizer">
                <button
                  type="button"
                  className=" text-white bg-primary hover:bg-dark_01 focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-lg lg:text-lg px-5 py-2.5 text-center me-2 mb-2"
                >
          ...
          <div className="px-4 py-6">
            ...
            <div className="flex justify-center">
              <Link to="/shop">
                <button
                  type="button"
                  className=" text-white bg-primary hover:bg-dark_01 focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg lg:text-lg px-5 py-2.5 text-center me-2 mb-2"
                >
