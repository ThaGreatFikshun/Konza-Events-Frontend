  ...
  return (
    <>
      ...
      <div className="flex justify-center  ">
        <div className="bg-white rounded-lg pt-7 py-2 w-full md:w-2/3 md:px-6">
          <form onSubmit={handleSubmitReview} className="grid justify-center">
            ...
            <div className="font-bold w-full md:w-4/5 mx-auto mt-3 border-red-600 text-center">
              ...
              <div>
                {[1, 2, 3, 4, 5].map((value) => (
                  <button key={value} type="button" className={`text-2xl focus:outline-none ${value <= rating ? 'text-primary' : 'text-gray-300'}`} onClick={() => handleStarClick(value)}>★</button>
                ))}
              </div>
            ...
            <input type="submit" value="Add Review" className="text-white w-full md:w-auto mx-auto mt-4 p-2 bg-dark_01 hover:bg-gradient-to-br focus:outline-none focus:ring-pink-300 dark:focus:ring-pink-800 shadow-lg shadow-pink-500/50 dark:shadow-lg dark:shadow-pink-800/80 lg:w-auto hover:bg-red-600 focus:ring-4 focus:ring-opacity-50 rounded-lg px-5 mb-5" />
          </form>
        </div>
      </div>
    </>
