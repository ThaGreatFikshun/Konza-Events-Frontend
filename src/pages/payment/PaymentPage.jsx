        ...
        <div className='mt-16 col-span-2 md:col-span-1'>
          ...
          <div className='bg-slate-100 rounded-md border-2 border-black mt-7 p-5 pb-12'>
            ...
            <div className='flex md:flex-col lg:flex-row gap-3 lg:gap-5 justify-between mt-4'>
              ...
              <h2 className='font-semibold text-xl'>Ksh {ticketPrice}</h2>
            </div>
            <div className='mt-5'>
            ...
            <div className='flex mt-4 justify-between items-center'>
              <h2>Taxes</h2>
              <p className='font-semibold'>Ksh {taxes}</p>
            </div>
            <hr className='h-[1.6px] mt-1 bg-secondary' />
            <div className='flex mt-4 justify-between items-center'>
              <h2 className='text-2xl font-semibold'>Total</h2>
              <p className='font-semibold text-2xl'>Ksh {totalPrice}</p>
            </div>
            <div className='mt-4 flex gap-2'>
              <h2 className='text-lg text-secondary font-semibold'>Buy more ticket</h2>
            ...
            <div className='flex flex-col items-center'>
              {user ?
                <button
                  ...
                  className='bg-primary w-full rounded-md py-2 mt-2 text-white font-medium lg:text-xl text-xl md:text-sm'
                >
                  Continue to secure payment
                </button>
                :
                <Link className='w-full' to='/login'><button
                  className='bg-primary w-full rounded-md py-2 px-4  mt-2 text-white font-medium lg:text-xl text-xl md:text-sm'
                >
                  Login to Purchase
                </button></Link>}
