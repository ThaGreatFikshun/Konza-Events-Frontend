...
const EditUser = () => {
    ...
    return (
        <div>
            ...
            <div className="bg-white dark:bg-[#0c1427] border dark:border-secondary  rounded py-2 px-3 md:w-3/4 mx-auto">
                <form
                ...
                >
                    <div className="flex flex-col md:flex-row md:gap-5">
                        <div className="md:w-1/2">
                            <label
                                htmlFor="name"
                                className="block text-sm font-medium text-secondary py-1.5"
                            >
                                Full Name
                            </label>
                            <input
