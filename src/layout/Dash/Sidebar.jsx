...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
    ...
    return (
        <>
            ...
            ></div>
            <div
                className={`fixed inset-y-0 left-0 z-30 w-64 flex flex-col bg-secondary min-h-screen transition duration-300 transform lg:translate-x-0 lg:static lg:inset-0 ${sidebarOpen
