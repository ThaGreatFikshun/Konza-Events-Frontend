...
const CustomEventUser = () => {
    ...
    return (
        <div>
            <h2 className='text-dark_01 text-2xl font-bold'>Requested Custom Events</h2>
            <div className='overflow-x-auto shadow-md mt-4'>
                <table className='table-auto w-full'>
                    <thead className="text-sm border-b text-primary capitalize bg-white font-semibold">
                        <tr>
                    ...
                    <tbody className=''>
                        {
                            customEvent?.map((event, index) => (
                                <tr key={event._id} className='text-center text-sm text-secondary dark:text-gray-400'>
