      ...
      <Container>
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 py-5">
          <div>
            ...
            <p className="mt-6 max-w-md text-center leading-relaxed text-secondary sm:max-w-xs sm:text-left">
              At Konza Events, we specialize in turning your events into
            ...
            <div className="text-center sm:text-left">
              ...
              <ul className="mt-8 space-y-4 text-sm">
                ...
                <li className="flex items-center justify-center gap-1.5 ">
                  ...
                  <span className="md:flex-1 text-secondary">
                  <a href="mailto:info@konzaevents.go.ke">info@konzaevents.go.ke</a>                  </span>
                </li>
                ...
                <li>
                  ...
                  >
                    ...
                    <span className="md:flex-1 text-secondary">
                      <a href="tel:+254700112233">+254700112233</a>
                    </span>
                  </Link>
                </li>
                <li className="flex items-start justify-center gap-1.5 ">
                  ...
                  <address className="-mt-0.5 md:flex-1 not-italic text-secondary">
                    Konza Technopolis</address>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="mt-12 border-t border-gray-100 py-6">
          <div className="text-center sm:flex sm:justify-between sm:text-left">
            ...
            <p className="mt-4 text-sm text-secondary sm:order-first sm:mt-0">
              © {new Date().getFullYear()} Konza Events
            </p>
          </div>
        </div>
      </Container>
